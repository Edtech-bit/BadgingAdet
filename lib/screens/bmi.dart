...
class BmiModule extends ToolModule {
  ...
  double _height = 0; double _weight = 0; double? _bmi; String? _category; Color? _bmiColor;
...
class _BmiModuleBody extends StatefulWidget {
  ...
  _BmiModuleBody({required this.module});
...
class _BmiModuleBodyState extends State<_BmiModuleBody> {
  ...
  @override
  void dispose() {
    _inputH.dispose();    _inputW.dispose();
    super.dispose();
  }
  ...
  void _calculateBmi() {
    ...
    setState(() { widget.module.calculateBmi(height, weight); });
  }
        ...
        children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [ Theme.of(context).primaryColor.withValues(alpha: 0.15), Colors.white ]
                ),
              ...
              child: Column(
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text('YOUR BMI', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Colors.grey, letterSpacing: 1)),
                      Container(
          ...
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Enter Details', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.blueGrey[900])),
                SizedBox(height: 20),
                Row(
                  children: [
                    ...
                    Expanded(
                      child: FilledButton(
                        ...
                        style: FilledButton.styleFrom(
                          backgroundColor: Theme.of(context).primaryColor, padding: EdgeInsets.symmetric(vertical: 16),
